...
parser.add_argument("--save_path", type=str, default="logs/PReNet_1_test", help='path to save models and log files')
...
def main():
    ...
    # Build model
    model = PReNet_1(recurrent_iter=opt.recurrent_iter, use_GPU=opt.use_gpu)
    print_network(model)
